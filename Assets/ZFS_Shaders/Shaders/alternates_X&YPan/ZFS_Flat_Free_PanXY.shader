...
////// Lighting:
////// Emissive:
                float2 node_2537 = i.uv0;
                float4 node_2533 = _Time + _TimeEditor;
                float4 node_2529 = _Time + _TimeEditor;
                float2 node_2539 = float2((node_2537.r+(node_2533.g*_Pan_SpeedX)),(node_2537.g+(node_2529.g*_Pan_SpeedY)));
                float4 node_896 = tex2D(_Texture,TRANSFORM_TEX(node_2539, _Texture));
                float node_1772 = 0.0;
                float2 node_3293 = i.uv0;
                float node_1805 = lerp( node_1772, tex2D(_Mask_Texture,TRANSFORM_TEX(node_3293.rg, _Mask_Texture)).r, _Mask );
