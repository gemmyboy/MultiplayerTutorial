...
////// Lighting:
////// Emissive:
                float2 node_2527 = i.uv0;
                float4 node_2496 = _Time + _TimeEditor;
                float4 node_2434 = _Time + _TimeEditor;
                float2 node_2533 = float2((node_2527.r+(node_2496.g*_Pan_SpeedX)),(node_2527.g+(node_2434.g*_Pan_SpeedY)));
                float4 node_896 = tex2D(_Texture,TRANSFORM_TEX(node_2533, _Texture));
                float node_1772 = 0.0;
