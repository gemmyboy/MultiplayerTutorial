...
////// Lighting:
////// Emissive:
                float2 node_2536 = i.uv0;
                float4 node_2532 = _Time + _TimeEditor;
                float4 node_2528 = _Time + _TimeEditor;
                float2 node_2538 = float2((node_2536.r+(node_2532.g*_Pan_SpeedX)),(node_2536.g+(node_2528.g*_Pan_SpeedY)));
                float4 node_896 = tex2D(_Texture,TRANSFORM_TEX(node_2538, _Texture));
                float node_1772 = 0.0;
