...
////// Lighting:
////// Emissive:
                float2 node_2538 = i.uv0;
                float4 node_2534 = _Time + _TimeEditor;
                float4 node_2530 = _Time + _TimeEditor;
                float2 node_2540 = float2((node_2538.r+(node_2534.g*_Pan_SpeedX)),(node_2538.g+(node_2530.g*_Pan_SpeedY)));
                float4 node_896 = tex2D(_Texture,TRANSFORM_TEX(node_2540, _Texture));
                float node_1772 = 0.0;
                float2 node_3022 = i.uv0;
                float node_1805 = lerp( node_1772, tex2D(_Mask_Texture,TRANSFORM_TEX(node_3022.rg, _Mask_Texture)).r, _Mask );
