...
public class OrbRotate : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        newPosition.y = transform.position.y + defaultHeight;
    ...
    void Update()
    {
        ...
        if (yOrbit == true)
        {
            ...
            if (clockwiseRotate == true)
            {
                ...
                Vector3 direction = transform.position - orbitObject.transform.position;
                direction.Normalize();

                Vector3 directionNormalized = direction * orbitScale;
                transform.position = orbitObject.transform.position + directionNormalized;
            ...
            {
                orbitPosition.y = orbitObject.transform.position.y + defaultHeight;
                Vector3 newPos = transform.position;
                newPos.y = orbitPosition.y;
